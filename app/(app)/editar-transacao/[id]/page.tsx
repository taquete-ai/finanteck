...
export default function EditarTransacaoPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    async function loadTransaction() {
      try {
        ...
        if (!transaction) {
          setServerError('Transação não encontrada.')
          return
        }
        ...
        setServerError('Erro ao carregar transação.')
      } finally {
        setLoading(false)
      }
    }
      ...
      <div className="p-6 max-w-xl mx-auto">
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            <svg className="w-8 h-8 animate-spin text-green-600 mx-auto mb-4" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Atualize os dados da transação</p>
      </div>
      ...
      <Card>
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button type="submit" fullWidth loading={saving} disabled={saved}>
              {saved ? 'Salvo!' : 'Salvar'}
            </Button>
          </div>
        </form>
